...
const scheduleOutPath = path.join(__dirname, "../src/content/festivals/feq-2026/schedule.json");
const artistDetailsOutPath = path.join(__dirname, "../src/content/festivals/feq-2026/artist-details.json");
const overridesPath = path.join(__dirname, "../src/content/festivals/feq-2026/youtube-overrides.json");
...
await fs.mkdir(path.dirname(scheduleOutPath), { recursive: true });
